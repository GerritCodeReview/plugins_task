  ...
  <div class="task_summary" hidden$="[[!_can_show(ready_count, fail_count)]]">
    <table>
      <tr>
        ...
        <td class="value">
          <gr-task-chip chip_style="warning" hidden$="[[!ready_count]]">[[ready_count]] needs</gr-task-chip>
          <gr-task-chip chip_style="error" hidden$="[[!fail_count]]">[[fail_count]] blocked</gr-task-chip>
        </td>
      </tr>
    </table>
  </div>
