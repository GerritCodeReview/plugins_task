...
class GrTaskSummary extends Polymer.Element {
  ...
  _can_show_chips(ready_count, fail_count, invalid_count, waiting_count, duplicate_count, pass_count) {
    return ready_count || fail_count || invalid_count || waiting_count || duplicate_count || pass_count;
  }
}
