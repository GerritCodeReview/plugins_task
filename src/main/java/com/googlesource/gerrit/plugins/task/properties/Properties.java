...
public class Properties {
  ...
  public static class FieldConverterImpl implements AbstractExpander.FieldConverter {
    @Override
  ...
  public Properties() {
    this(null, null);
    expander = new Expander(n -> "", new FieldConverterImpl());
  }
  ...
  public Task getTask(ChangeData changeData) {
    try (StopWatch stopWatch =
      ...
      expander = new Expander(n -> loader.load(n), new FieldConverterImpl());
