            ...
            Optional<Task> def =
                preloader.getOptionalTask(
                    taskExpressionFactory.create(
                        relativeSubTask.file(), relativeSubTask.subTask()));
            if (def.isPresent()) {
            ...
            addPreloaded(
                preloader.getTasks(
                    FileKey.create(
                        ...
                        resolveTaskFileName(relativeSubTask.subTask()))));
          ...
          try {
            External ext =
                taskConfigFactory
                    ...
                    .getExternal(relativeSubTask.subTask());
            if (ext == null) {
              addInvalidNode();
            } else {
      ...
      protected void addSubTasksFactoryTasks()
        ...
        for (RelativeSubTask relativeSubTask : task.subTasksFactories) {
          TasksFactory tasksFactory =
              taskConfigFactory
                  .getTaskConfig(relativeSubTask.file())
                  .getTasksFactory(relativeSubTask.subTask());
