...
public class TaskConfig extends AbstractVersionedMetaData {
  ...
  public class TaskBase extends SubSection {
    ...
    public List<SubSectionKey> subTasksExternals;
    public List<SubSectionKey> subTasksFactories;
    public List<FileKey> subTasksFiles;
    ...
    public TaskBase(SubSectionKey s, boolean isVisible, boolean isMasqueraded) {
      ...
      subTasksExternals =
          getStringList(s, KEY_SUBTASKS_EXTERNAL).stream()
              .map(subtask -> SubSectionKey.create(s.file(), SECTION_EXTERNAL, subtask))
              .collect(Collectors.toList());
      subTasksFactories =
      ...
      subTasksFiles =
          getStringList(s, KEY_SUBTASKS_FILE).stream()
              .map(fileName -> FileKey.create(s.file().branch(), fileName))
              .collect(Collectors.toList());
    }
