...
public class TaskConfig extends AbstractVersionedMetaData {
  ...
  public class TaskBase extends SubSection {
    ...
    public List<RelativeSubTask> subTasks;
    public List<RelativeSubTask> subTasksExternals;
    public List<RelativeSubTask> subTasksFactories;
    public List<RelativeSubTask> subTasksFiles;
    ...
    public TaskBase(SubSectionKey s, boolean isVisible, boolean isMasqueraded) {
      ...
      subTasks =
          getStringList(s, KEY_SUBTASK).stream()
              .map(subTask -> RelativeSubTask.create(s.file(), subTask))
      ...
      subTasksFiles =
          getStringList(s, KEY_SUBTASKS_FILE).stream()
              .map(fileName -> RelativeSubTask.create(s.file(), fileName))
              .collect(Collectors.toList());
    }
  ...
  public TasksFactory getTasksFactory(String taskFactory) {
    return getTasksFactory(SubSectionKey.create(file, SECTION_TASKS_FACTORY, taskFactory));
  }
