...
public interface PluginProvidedTaskNamesFactory extends DynamicBean {
  static PluginProvidedTaskNamesFactory getProxyInstance(
    ...
    return getProxyInstance(bean);
  }

  static PluginProvidedTaskNamesFactory getProxyInstance(Object bean)
      throws ClassCastException, IllegalArgumentException {
    return Reflection.newProxy(
        PluginProvidedTaskNamesFactory.class,
  ...
  List<String> getNames(ChangeData change, List<String> args);
}
