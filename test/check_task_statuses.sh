...
DOC_STATES=$(replace_tokens "$ROOT_CONFIG_PRJ" "$ROOT_CONFIG_BRANCH" < "$DOCS/task_states.md")
DOC_PREVIEW=$(replace_tokens "$ROOT_CONFIG_PRJ" "$ROOT_CONFIG_BRANCH" < "$DOCS/preview.md")
DOC_PATHS=$(replace_tokens "$ROOT_CONFIG_PRJ" "$ROOT_CONFIG_BRANCH" < "$DOCS/paths.md")
